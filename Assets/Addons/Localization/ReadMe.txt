...
upper left corner, after you click it you will see that a text field is focus, writte a "Key ID" for your new sentence,
the key id should be short and prefered in lowercase for performance.
