...
public class bl_KillCam : bl_MonoBehaviour
{
    ...
    void Orbit()
    {
        ...
        if (target != null)
        {
            ...
            transform.position =  Vector3.Lerp(transform.position,vector3, Time.deltaTime * acceleration);
        }
    ...
    public void SetTarget(Player view, DamageCause cause, string killer, Transform secureTarget = null)
    {
        ...
        StartCoroutine(delayTime(killCamDelay, view,cause, killer, secureTarget));
    }
    ...
    IEnumerator delayTime(float s, Player view, DamageCause cause, string killer, Transform secureTarget = null)
    {
