...
public class bl_PlayerUIBank : MonoBehaviour
{
    ...
    public GameObject TwoTeamsScoreboard;
    public GameObject FFAScoreboard;
    ...
    public Text FFAFoePlayerText;
    public Text FFAFoePlayerScoreText;
    public Text FFALocalPlayerScoreText;
    ...
    public GameObject Team1ScoreCountUI;
    public GameObject Team2ScoreCountUI;

    public GameObject Team1ScoreBoardUI;
    public GameObject Team2ScoreBoardUI;
