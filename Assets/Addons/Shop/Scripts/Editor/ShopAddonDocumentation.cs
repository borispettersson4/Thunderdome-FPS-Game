...
public class ShopAddonDocumentation : TutorialWizard
{
    ...
    "have selected the coin pack and click on the purchase button), there is where: <b>bl_ShopManager.cs ->  public void BuyCoinPack(int id)) line 166 by default</b>, you'll see a <b>Switch</b> conditional with some payment options," +
