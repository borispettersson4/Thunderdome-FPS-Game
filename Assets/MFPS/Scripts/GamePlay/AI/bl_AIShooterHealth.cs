...
public class bl_AIShooterHealth : bl_PhotonHelper
{
    ...
    void MakeDamageRepeting()
    {
        ...
        DoDamage((int)info.Damage, bl_Localization.Instance.GetText("Burn"), info.Direction, bl_GameManager.m_view, false, PhotonNetwork.LocalPlayer.GetPlayerTeam(), false);
    }
