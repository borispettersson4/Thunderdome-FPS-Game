...
public class bl_PlayerDamageManager : bl_MonoBehaviour
{
    ...
    private int ScorePerKill, ScorePerHeadShot;
    ...
    /// </summary>
    [PunRPC]
    void SyncDamage(float damage, string killer, DamageCause cause, Vector3 m_direction, bool isHeadShot, int weaponID, Player m_sender)
    {
        ...
        {
            health = 0.0f;
            Die(m_LastShot, isHeadShot, cause, weaponID, m_direction, m_sender);
