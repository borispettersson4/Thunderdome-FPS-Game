public static class bl_GameTexts 
{
    ...
    public static string HeadShotBonus = "HeadShot Bonus";
    ...
    public static string OpenChatStart = "[Server]: Press 'T' or 'Y' to open chat";
    ...
    public static string CoverPointTime = "COVER POINT IN: <b>{0}</b>";
    ...
    public static readonly string[] RandomNames = new string[] { "Larry", "Mike", "Michael", "Jake", "Finn", "Stan", "Kenny", "Eric", "Felix", "Loki", "Tony", "2-D","Pablo","Hal",
    "Han", "Brian", "Pennywise", "Valmet", "Mikael", "Guillermo", "Eloy", "Cristian", "Otto", "Ethan", "Mars", "Pip", "Toby", "Hammond", "May", "Clarkson", "Chapplin", "Crush", "Dane", "Lex",
    "Ford", "Carlos", "Steven", "Tim", "Xander", "Alex", "Samuel", "Boris", "Morgan", "Braga", "Eve", "Adam", "Tom", "Doc", "Casper", "Api", "Nico", "Kimi", "Sebastian", "Charles", "Ricardo", "Albert",
    "Ferret", "Mattias", "Toei", "Damian", "Bruce", "Marcelo", "Enzo", "Ferdinand", "Pesci", "Gorby", "Billy",};
}