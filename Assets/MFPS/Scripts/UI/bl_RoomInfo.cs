...
public class bl_RoomInfo : MonoBehaviour {
    ...
    public void FakeGetInfo(RoomInfo info)
    {
        Lobby = FindObjectOfType<bl_Lobby>();
        cacheInfo = info;
        RoomNameText.text = "TestName";
        MapNameText.text = "Hangar";
        GameModeText.text = "Team Deathmatch";
        PlayersText.text = 4 + "/" + 12;
        MaxKillText.text = "100 Kills";
        PingText.text = "400" + " ms";
        bool _active = true;
