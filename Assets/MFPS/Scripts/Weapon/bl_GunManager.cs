...
public class bl_GunManager : bl_MonoBehaviour
{
    ...
    [Header("Player Class")]
    public List<PlayerClassLoadOut> m_Class = new List<PlayerClassLoadOut>() {};

    public PlayerClassLoadOut exampleClass;
    ...
    protected override void Awake()
    {
        ...
        //Load from save data class customization
        if(m_Class.Count < 5)
        {
            PlayerClassLoadOut PCL = new PlayerClassLoadOut
            {
                primary = PlayerPrefs.GetInt(ClassKey.PrimaryAssault),
                secondary = PlayerPrefs.GetInt(ClassKey.SecondaryAssault),
                Knife = PlayerPrefs.GetInt(ClassKey.KnifeAssault),
                Special = PlayerPrefs.GetInt(ClassKey.GrenadeAssault),
            };
            m_Class.Add(PCL);

            PlayerClassLoadOut PCL2 = new PlayerClassLoadOut
            {
                primary = PlayerPrefs.GetInt(ClassKey.PrimaryRecon),
                secondary = PlayerPrefs.GetInt(ClassKey.SecondaryRecon),
                Knife = PlayerPrefs.GetInt(ClassKey.KnifeRecon),
                Special = PlayerPrefs.GetInt(ClassKey.GrenadeRecon),
            };
            m_Class.Add(PCL2);

            PlayerClassLoadOut PCL3 = new PlayerClassLoadOut
            {
                primary = PlayerPrefs.GetInt(ClassKey.PrimaryEnginner),
                secondary = PlayerPrefs.GetInt(ClassKey.SecondaryEnginner),
                Knife = PlayerPrefs.GetInt(ClassKey.KnifeEnginner),
                Special = PlayerPrefs.GetInt(ClassKey.GrenadeEnginner),
            };
            m_Class.Add(PCL3);

            PlayerClassLoadOut PCL4 = new PlayerClassLoadOut
            {
                primary = PlayerPrefs.GetInt(ClassKey.PrimarySupport),
                secondary = PlayerPrefs.GetInt(ClassKey.SecondarySupport),
                Knife = PlayerPrefs.GetInt(ClassKey.KnifeSupport),
                Special = PlayerPrefs.GetInt(ClassKey.GrenadeSupport),
            };
            m_Class.Add(PCL4);

            PlayerClassLoadOut PCL5 = new PlayerClassLoadOut
            {
                primary = PlayerPrefs.GetInt(ClassKey.PrimaryGrenadier),
                secondary = PlayerPrefs.GetInt(ClassKey.SecondaryGrenadier),
                Knife = PlayerPrefs.GetInt(ClassKey.KnifeGrenadier),
                Special = PlayerPrefs.GetInt(ClassKey.GrenadeGrenadier),
            };
            m_Class.Add(PCL5);
    ...
    void GetClass()
    {
        ...
        switch (bl_RoomMenu.PlayerClass)
        {
            case PlayerClass.Assault:
                PlayerEquip[0] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.PrimaryAssault));
                PlayerEquip[1] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.SecondaryAssault));
                PlayerEquip[2] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.GrenadeAssault));
                PlayerEquip[3] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.KnifeAssault));
                break;
            case PlayerClass.Recon:
                PlayerEquip[0] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.PrimaryRecon));
                PlayerEquip[1] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.SecondaryRecon));
                PlayerEquip[2] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.GrenadeRecon));
                PlayerEquip[3] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.KnifeRecon));
                break;
            case PlayerClass.Engineer:
                PlayerEquip[0] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.PrimaryEnginner));
                PlayerEquip[1] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.SecondaryEnginner));
                PlayerEquip[2] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.GrenadeEnginner));
                PlayerEquip[3] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.KnifeEnginner));
                break;
            case PlayerClass.Support:
                PlayerEquip[0] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.PrimarySupport));
                PlayerEquip[1] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.SecondarySupport));
                PlayerEquip[2] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.GrenadeSupport));
                PlayerEquip[3] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.KnifeSupport));
                break;
            case PlayerClass.Grenadier:
                PlayerEquip[0] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.PrimaryGrenadier));
                PlayerEquip[1] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.SecondaryGrenadier));
                PlayerEquip[2] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.GrenadeGrenadier));
                PlayerEquip[3] = GetGunOnListById(PlayerPrefs.GetInt(ClassKey.KnifeGrenadier));
                break;
        }
    ...
    public class PlayerClassLoadOut
    {
        ...
        public int primary_sight = 0;
        public int primary_barrel = 0;
        public int primary_mag = 0;
        public int primary_mod = 0;
        /// <summary>
        /// the ID of the secondary Gun Equipped
        /// </summary>
        public int secondary = 1;
        public int secondary_sight = 0;
        public int secondary_barrel = 0;
        public int secondary_mag = 0;
        public int secondary_mod = 0;
        /// <summary>
        /// 
        /// </summary>
        public int Knife = 3;
        public int knife_mod = 0;
        /// <summary>
        /// the ID the a special weapon
        /// </summary>
        public int Special = 2;
        public int Special_mod = 0;
        /// <summary>
        /// the ID the a special weapon
        /// </summary>
        public int perk = 4;
